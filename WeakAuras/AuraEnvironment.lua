...
WeakAuras.GetNamePlateForUnit = function(unit, nameplateFrame)
  if nameplateFrame or (unit and Private.multiUnitUnits.nameplate[unit]) then
    return LGF.GetUnitNameplate(unit, nameplateFrame)
  end
end
