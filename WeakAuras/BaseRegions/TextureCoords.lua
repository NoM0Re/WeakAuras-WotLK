...
-- Backport hook used by the WotLK circular spinner implementation. Upstream keeps
-- this local, but exposing it here lets the 4-texture spinner share the same
-- transform math without copying the function into another module.
Private.TextureCoords.TransformPoint = TransformPoint
